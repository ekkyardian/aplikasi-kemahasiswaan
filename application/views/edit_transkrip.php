                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="npm" id="npm">
                                    <option value="<?php echo $dataTaranskrip['npm'] ?>">
                                        <?php echo $dataTaranskrip['npm'] . " | " . $dataTaranskrip['nama_mhs']; ?>
                                    </option>
                                    <option value="">---</option>
                                    <?php
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="smt" id="smt">
                                    <option value="<?php echo $dataTaranskrip['smt'] ?>">
                                        <?php echo $dataTaranskrip['smt'] ?>
                                    </option>
                                    <option value="">---</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="kode_mk" id="kode_mk">
                                    <option value="<?php echo $dataTaranskrip['kode_mk'] ?>">
                                        <?php echo $dataTaranskrip['kode_mk'] . " | " . $dataTaranskrip['nama_mk'] ?>
                                    </option>
                                    <option value="">---</option>
                                    <?php
                                    $conn = mysqli_connect("localhost", "root", "");
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="huruf_mutu" id="huruf_mutu">
                                    <option value="<?php echo $dataTaranskrip['huruf_mutu'] ?>">
                                        <?php echo $dataTaranskrip['huruf_mutu'] ?>
                                    </option>
                                    <option value="">---</option>
